...
class VBULLETIN5_Converter_Module_Moderators extends Converter_Module_Moderators {
	...
	function import()
	{
		...
		$query = $this->old_db->simple_select("moderator", "*", "forumid > 0", array('limit_start' => $this->trackers['start_mods'], 'limit' => $import_session['mods_per_screen']));
	...
	function fetch_total()
	{
		...
		{
			$query = $this->old_db->simple_select("moderator", "COUNT(*) as count", "forumid > 0");
