...
class IPB4_Converter_Module_Privatemessages extends Converter_Module_Privatemessages {
	...
	function import()
	{
		...
		$query = $this->old_db->query("
			...
			LEFT JOIN ".OLD_TABLE_PREFIX."core_message_topic_user_map mp ON(mt.mt_id=mp.map_topic_id)
	...
	function get_username($username)
	{
		...
		$query = $this->old_db->simple_select("core_members", "*", "name='{$username}'", array('limit' => 1));
